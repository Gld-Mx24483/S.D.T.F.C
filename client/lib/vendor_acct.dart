...
class VendorMyAcctScreen extends StatefulWidget {
  const VendorMyAcctScreen({super.key});

  @override
  State<VendorMyAcctScreen> createState() => _VendorMyAcctScreenState();
}

class _VendorMyAcctScreenState extends State<VendorMyAcctScreen> {
