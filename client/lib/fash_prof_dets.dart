...
class FashProfileDetails extends StatefulWidget {
  final String selectedLocationName;
  final String address;
  final String phoneNumber;

  const FashProfileDetails({
    super.key,
  ...
  @override
  State<FashProfileDetails> createState() => _FashProfileDetailsState();
}

class _FashProfileDetailsState extends State<FashProfileDetails> {
