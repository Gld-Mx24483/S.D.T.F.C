...
class VendorNotsScreen extends StatefulWidget {
  const VendorNotsScreen({super.key});

  @override
  State<VendorNotsScreen> createState() => _VendorNotsScreenState();
}

class _VendorNotsScreenState extends State<VendorNotsScreen> {
